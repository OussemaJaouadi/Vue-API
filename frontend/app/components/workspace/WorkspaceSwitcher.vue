...
<template>
  <DropdownMenu>
    ...
    <DropdownMenuContent class="w-64 rounded-none border-2 border-primary/20 bg-background p-1 shadow-[6px_6px_0_0_rgba(16,185,129,0.1)]" align="start">
      ...
      <NuxtLink
        class="mt-1 flex items-center justify-center border-t border-border/30 px-3 py-2.5 font-mono text-[10px] font-black uppercase tracking-widest text-primary transition-colors hover:bg-primary/8"
        to="/workspaces"
      >
        Manage workspaces
      </NuxtLink>
