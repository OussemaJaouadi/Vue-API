...
func environmentTestDeps(t *testing.T) (*echo.Echo, string) {
	t.Helper()
...
func TestEnvironmentRoutes_GetEnvironments_MissingWorkspaceID(t *testing.T) {
	router, token := environmentTestDeps(t)
...
func TestEnvironmentRoutes_GetEnvironments_Empty(t *testing.T) {
	...
	resp := performJSON(router, http.MethodGet, "/v1/environments?workspaceId=ws1", nil, token)
...
func TestEnvironmentRoutes_GetEnvironments_WithData(t *testing.T) {
	...
	getResp := performJSON(router, http.MethodGet, "/v1/environments?workspaceId=ws1", nil, token)
...
func TestEnvironmentRoutes_DeleteEnvironment(t *testing.T) {
	...
	delResp := performJSON(router, http.MethodDelete, "/v1/environments/"+envID, nil, token)
...
func TestEnvironmentRoutes_DeleteEnvironment_NotFound(t *testing.T) {
	...
	resp := performJSON(router, http.MethodDelete, "/v1/environments/nonexistent", nil, token)
	assert.Equal(t, http.StatusNotFound, resp.Code)
}
...
func TestEnvironmentRoutes_DeleteVariable(t *testing.T) {
	...
	delResp := performJSON(router, http.MethodDelete, "/v1/environments/"+envID+"/variables/"+varID, nil, token)
	assert.Equal(t, http.StatusNoContent, delResp.Code)
}
...
func TestEnvironmentRoutes_DeleteVariable_NotFound(t *testing.T) {
	...
	resp := performJSON(router, http.MethodDelete, "/v1/environments/ws1/variables/nonexistent", nil, token)
	assert.Equal(t, http.StatusNotFound, resp.Code)
}
